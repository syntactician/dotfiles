...
cd ~
sudo mkdir /usr/share/zsh/site-functions ~/.builds ~/.vim ~/.vim/bundle ~/.zsh ~/.i3 ~/.config/zathura ~/.config/dunst ~/.config/xfce4 ~/.config/xfce4/xfconf ~/.config/xfce4/xconf/xfce-perchannel-xml
...
cd ~
sudo cp -r ~/.builds/flattr-icons/Flattr /usr/share/icons/
